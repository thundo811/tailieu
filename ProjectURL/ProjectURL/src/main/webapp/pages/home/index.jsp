...
<html>
    ...
    <body class="no-zc one-or-more-links">
            ...
            <div id="container" class="clearfix">
                ...
                <div class="container container-pod shorten-container">
                    ...
                    <div id="form_container" class="t-center mid-container foot-room">
                        <form:form modelAttribute="su" method="POST" name="shortenUrl" id="unAuthShortenForm" >
                            <fieldset class="cf">
                                ...
                                <input id="shorten_btn" type="submit" class="button button-primary button-large shorten-button" value="ShortURL" />
                    ...
                    <div class="link-container mid-container">
                        ...
                        <div>
                            <ul id="anon_history" class="anon_history" style="display: block;">
                                <li id="1fz1hn4" class="shortened_link" data-user_hash="1fz1hn4" data-short_link="http://bit.ly/1fz1hn4">
                                    <div class="unauth-title">
                                        <a class="article-title" href="http://face.com/">Pranks.com - For the prank lovers in all of us.</a>
                                    </div>
                                    <div class="unauth-title-url">
                                        <a class="article-title smaller" href="http://face.com/">face.com/</a>
                                    </div>
                                    <div class="unauth_capsule clearfix">
                                        <a class="short-url" href="http://bit.ly/1fz1hn4">http://bit.ly/1fz1hn4</a>
                                        <input class="copy-input" value="http://bit.ly/1fz1hn4" tabindex="-1" readonly="readonly">
                                        <a href="#" class="copy button primary">Copy</a>
                                        <a class="info_page" href="https://bitly.com/1fz1hn4+">
                                ...
                                <li id="2FhY5Ag" class="shortened_link" data-user_hash="2FhY5Ag" data-short_link="http://bit.ly/2FhY5Ag">
                                    <div class="unauth-title">
                                        <a class="article-title" href="https://garena.live/">Garena LIVE</a>
                                    </div>
                                    <div class="unauth-title-url">
                                        <a class="article-title smaller" href="https://garena.live/">garena.live/</a>
                                    </div>
                                    <div class="unauth_capsule clearfix">
                                        <a class="short-url" href="http://bit.ly/2FhY5Ag">http://bit.ly/2FhY5Ag</a>
                                        <input class="copy-input" value="http://bit.ly/2FhY5Ag" tabindex="-1" readonly="readonly">
                                        <a href="#" class="copy button primary">Copy</a>
                                        <a class="info_page" href="https://bitly.com/2FhY5Ag+">
                                            <i class="default fa fa-bar-chart-o"></i> 0</a>
                                    </div>
                                </li>
                                <li id="2H7VZ6x" class="shortened_link" data-user_hash="2H7VZ6x" data-short_link="http://bit.ly/2H7VZ6x">
                                    <div class="unauth-title">
                                        <a class="article-title" href="https://www.youtube.com/watch?v=Ul2AjWL2Ibg">ViruSs Liveeeeee - YouTube</a>
                                    </div>
                                    <div class="unauth-title-url">
                                        <a class="article-title smaller" href="https://www.youtube.com/watch?v=Ul2AjWL2Ibg">youtube.com/watch?v=Ul2AjWL2Ibg</a>
                                    </div>
                                    <div class="unauth_capsule clearfix">
                                        <a class="short-url" href="http://bit.ly/2H7VZ6x">http://bit.ly/2H7VZ6x</a>
                                        <input class="copy-input" value="http://bit.ly/2H7VZ6x" tabindex="-1" readonly="readonly">
                                        <a href="#" class="copy button primary">Copy</a>
                                        <a class="info_page" href="https://bitly.com/2H7VZ6x+">
                                            <i class="default fa fa-bar-chart-o"></i> 0</a>
                                    </div>
                                </li>
                            </ul>
        ...
        <!--        <script>
                    ...
                    document, 'script', '<c:url value="/resources/connect.facebook.net/en_US/fbevents.js"/>');
                    fbq('init', '863117047105619');
                    fbq('track', "PageView");
                </script>-->
        ...
        <script type="text/javascript">if (window.twttr) {
                twttr.conversion.trackPid('l6rvc', {tw_sale_amount: 0, tw_order_quantity: 0});
            }</script>
        <noscript>
